    ...
    <>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <div className="fixed top-20 left-0 right-0 glass-strong mx-4 rounded-2xl p-6 max-h-[80vh] overflow-y-auto">
            <div className="flex flex-col space-y-4">
              <button
                onClick={() => scrollToSection("home")}
                className="text-left hover:text-purple-soft transition-colors duration-300"
              >
                🏠 Início
              </button>
              {isAboutVisible && (
              ...
              {configs?.find(c => c.key === 'sections_visibility')?.value?.['photo-carousel'] !== false && (
                <button
                  onClick={() => scrollToSection("photo-carousel")}
                  className="text-left hover:text-purple-soft transition-colors duration-300"
                >
                  📸 Galeria
                </button>
              ...
              {configs?.find(c => c.key === 'sections_visibility')?.value?.faq !== false && (
                <button
              ...
              {configs?.find(c => c.key === 'sections_visibility')?.value?.inspirational !== false && (
                <button
