...
export function TestimonialsCarousel() {
  ...
  return (
    <section id="testimonials" data-section="testimonials" className="main-section relative overflow-hidden" style={{ margin: 0, padding: 0 }}>
                    ...
                    <div className="flex justify-center mb-4">
                      <div className="flex text-yellow-400">
                        ...
                        {[...Array(5 - testimonial.rating)].map((_, i) => (
                          <Star key={i + testimonial.rating} className="text-gray-300" size={16} />
                        ))}
                      </div>
                    </div>
